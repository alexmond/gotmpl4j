...
### Added
- Consolidated pre-1.0 development line (0.1.0 – 0.3.2, 2026-06-23 – 2026-06-24): gotmpl4j
  extracted from [jhelm](https://github.com/alexmond/jhelm) into a standalone project, with the
