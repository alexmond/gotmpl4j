...
/**
 * Implements Go's {@code printf} builtin: a {@code fmt.Sprintf}-compatible formatter that
 * reproduces Go's verb handling, nil/typed-nil markers, and missing/invalid-specifier
 * behavior. Extracted from {@link Functions} to keep that file focused.
 */
