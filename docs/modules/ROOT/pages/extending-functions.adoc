...
The https://www.alexmond.org/gotmpl4j-spring-boot/current/[gotmpl4j-spring-boot^] starter
wires the SPI the Spring-idiomatic way (mirroring how Thymeleaf collects
...
Both are then callable from any view the starter's
https://www.alexmond.org/gotmpl4j-spring-boot/current/spring-boot-starter.html[`GoTemplateService`^]
renders.
