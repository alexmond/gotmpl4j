...
* {api-core}/{gotmpl4j-version}/index.html[`gotmpl4j-core` API^] — the engine, `GoTemplate`, the function SPI.
* {api-sprig}/{gotmpl4j-version}/index.html[`gotmpl4j-sprig` API^] — the Sprig function library.
* {api-starter}/{gotmpl4j-version}/index.html[`gotmpl4j-spring-boot-starter` API^] — the Spring Boot integration.
